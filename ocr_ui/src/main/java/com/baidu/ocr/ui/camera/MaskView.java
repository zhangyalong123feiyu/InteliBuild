...
public class MaskView extends View {
    ...
    public static final int MASK_TYPE_NALMAL_CAMER = 12;//自定义拍照

    @IntDef({MASK_TYPE_NONE, MASK_TYPE_ID_CARD_FRONT, MASK_TYPE_ID_CARD_BACK, MASK_TYPE_BANK_CARD,MASK_TYPE_NALMAL_CAMER})
    @interface MaskType {
