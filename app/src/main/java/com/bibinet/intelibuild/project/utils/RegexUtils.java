...
public class RegexUtils{
    ...
    //判断字符串中包含的是那种单位
    public static String containsWich(String string){
        String pattern_Ω = ".*Ω.*";
        String pattern_KΩ = ".*KΩ.*";
        String pattern_MΩ = ".*MΩ.*";
        if (Pattern.matches(pattern_Ω, string)) {
            return "Ω";
        }else if (Pattern.matches(pattern_KΩ, string)) {
            return "KΩ";
        }else {
            return "MΩ";
        }
